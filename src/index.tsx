...
import { ReactTablePlaygroundSettings, setSettings } from './settings';

export const pluginName = 'react-table-playground';
...
export const fetchSettings =
  (): Promise<ReactTablePlaygroundSettings | void> => {
    const settingsPath = process.env
      .REACT_APP_REACT_TABLE_PLAYGROUND_BUILD_DIRECTORY
      ? process.env.REACT_APP_REACT_TABLE_PLAYGROUND_BUILD_DIRECTORY +
        'react-table-playground-settings.json'
      : '/react-table-playground-settings.json';
    return axios
      .get<ReactTablePlaygroundSettings>(settingsPath)
      .then((res) => {
